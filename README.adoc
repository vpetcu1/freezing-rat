...
----
$ git clone git@github.com:vpetcu1/freezing-rat
...
== More Information
You can learn more about this booster and the Thorntail runtime in the link:http://launcher.fabric8.io/docs/thorntail-runtime.html[Thorntail Runtime Guide].
